...
namespace Tayx.Graphy.Advanced
{
    public class G_AdvancedData : MonoBehaviour, IMovable, IModifiableState
    {
        ...
        private void Init()
        {
            ...
            (
                m_rectTransform.anchoredPosition.x - m_rectTransform.rect.width / 2
        ...
        [SerializeField] private Text m_gameVRResolutionText;
        ...
        private void Update()
        {
            ...
            if (m_deltaTime > 1f / m_updateRate)
            {
                ...
                if (XRSettings.enabled)
                {
                    ...
                    if (m_displaySubsystems.Count > 0) m_displaySubsystems[0].TryGetDisplayRefreshRate(out refreshRate);
